...
public class TestStationsService {
    ...
    @Test
    public void createNewPassengerTest () throws SQLException {
        Assert.assertTrue(userService.registration(testUser));
        System.out.println(generateUser().getLogin());
        System.out.println(generateUser().getPassword());
    }
